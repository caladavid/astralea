              ...
              <div className={`${isOpen ? 'h-[38%] transition-all' : 'h-0 hidden transition-all'}fixed top-0 right-0 w-full transition-all bg-bgColor md:hidden pt-8`}>
                <div>
                  <div className='flex justify-between border-b border-customGray w-4/5 sm:w-9/12 2xl:w-3/5 mx-auto pb-4'>
                    <Link href='/'
                      className={`${isAnimeRoute ? "md:fill-white md:stroke-white " : ""} flex items-center z-10 hover:text-secondaryColor hover:fill-secondaryColor hover:stroke-secondaryColor  transition-colors`}>
                      <LogoSVG />
                      <span>
                        Astralea
                      </span>
                  ...
                  <div className='flex flex-col w-4/5 sm:w-9/12 2xl:w-3/5 mx-auto py-4 gap-4 '>
